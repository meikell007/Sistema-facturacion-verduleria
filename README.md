...
**Eco Fruver** es un sistema web de punto de venta (POS) diseñado para gestionar las operaciones diarias de una verdulería de barrio.

Permite registrar ventas en efectivo o a crédito, administrar el catálogo de productos, gestionar clientes y su cartera de deudas, y generar reportes internos con pista de auditoría completa.
...
El servidor API queda disponible en:
